...
def entrenar_modelo_xgb(df, circuit, year):
    save_path = f"./xgb_model_{circuit}_{year}.pkl"
...
if __name__ == "__main__":
    ...
    raw_df_combined.to_csv("ALL_CIRCUITS_raw_combined.csv", index=False)

    full_df = preparar_dataset_vuelta_a_vuelta(raw_df_combined)
